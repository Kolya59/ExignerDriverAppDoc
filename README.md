...
## Как оно будет устроено
   _Disclaimer: Терминал = iOT устройство компании Galileosky._
   1. Онлайн-режим
   2. Оффлайн-режим
...
## Как это реализовать?
   ...
   > У нас было 4 фронтенедра (Angular), 2 бэкендера (Golang), 10 embeded developer (C/C++) и ни одного мобильного разработчика. Не то чтобы все эти люди должны были участвовать в разработке мобильного приложения, но раз уж начал описывать текущий стек компании, то нужно описать его до конца. Так же был/есть/будет готовый, объемный, схожий по функционалу код для web-части. А еще были сроки реализации рабочего прототипа - 2 недели, за это время написать с нуля подобный сервис без опыта практически невозможно.
